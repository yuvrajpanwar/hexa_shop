...
@section('content')
    ...
    <div class="container-fluid mb-4">
        <div class="row">
            <div class="col-12 d-flex justify-content-end">
                <a href="{{ route('add_permission') }}"><button class="btn btn-primary">Add New Permission</button></a>
            </div>
        </div>
    </div>
    ...
    <script>
        function showModel(id) {
            ...
            formDelete.action = 'destroy_permission/' + id;
        ...
        <table id="example" class="table table-striped" style="width:100%">
            ...
            <thead>
                <tr>
                    ...
                    <th style="color: blue"><b>Group Name</b></th>
                    <th style="color: blue"><b>Permission Name</b></th>
                ...
                @foreach ($permissions as $key => $item)
                    <tr>
                        ...
                        <td><a data-toggle="modal" data-target="#verticalModal" onClick='showModel({!! $item->id !!})'
                                style="color: red"> <span class="fe fe-24 fe-trash-2 "></span></a> | <a href=""><span
