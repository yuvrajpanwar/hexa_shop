      ...
      <tbody>
        @foreach ($users as $user)
            <tr>
              ...
              <td><button class="btn btn-danger mr-1" data-toggle="modal" data-target="#verticalModal" onClick='showModel({!! $user->id !!})' >Delete</button><a href="{{ route('edit_admin_details', ['user' => $user->id]) }}" class="btn btn-success">Edit</a>
              </td>
            </tr>
        @endforeach
      </tbody>
